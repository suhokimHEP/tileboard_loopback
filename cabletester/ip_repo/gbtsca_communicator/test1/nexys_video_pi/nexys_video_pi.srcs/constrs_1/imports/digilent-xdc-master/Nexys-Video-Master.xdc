...
set_property -dict {CLOCK_DEDICATED_ROUTE FALSE} [get_nets spi_sck]
...
create_clock -period 30.000 -name spi_sck -waveform {0.000 15.000} [get_ports spi_sck]
...
#SCA connections....
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVDS_25 } [get_ports { fmc_clk200_n }]; #IO_L13N_T2_MRCC_15 Sch=fmc_la00_cc_n
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVDS_25 } [get_ports { fmc_clk200_p }]; #IO_L13P_T2_MRCC_15 Sch=fmc_la00_cc_p

set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS25 } [get_ports { fmc_sw3 }]; #IO_L14N_T2_SRCC_15 Sch=fmc_la_n[12]
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS25 } [get_ports { fmc_sw4 }]; #IO_L14P_T2_SRCC_15 Sch=fmc_la_p[12]

set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS25 } [get_ports { fmc_led4 }]; #IO_L9N_T1_DQS_16 Sch=fmc_la_n[32]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS25 } [get_ports { fmc_led3 }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[32]


set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS25 } [get_ports { sca_resetb }]; #IO_L16N_T2_16 Sch=fmc_la_n[27]
set_property -dict { PACKAGE_PIN M22   IOSTANDARD LVCMOS25 } [get_ports { aux_link_disable }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=fmc_la_n[06]
set_property -dict { PACKAGE_PIN N22   IOSTANDARD LVCMOS25 } [get_ports { i2c_link_enable }]; #IO_L15P_T2_DQS_15 Sch=fmc_la_p[06]


set_property -dict { PACKAGE_PIN B21   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio_clk }]; #IO_L21P_T3_DQS_16 Sch=fmc_la_p[23]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio0 }]; #IO_L10N_T1_16 Sch=fmc_la_n[30]
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio1 }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[32]
set_property -dict { PACKAGE_PIN B13   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio2 }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN C13   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio8 }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio9 }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio10 }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio11 }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS25 } [get_ports { sca_gpio12 }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]

set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVDS_25 } [get_ports { fmc_miso_p }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVDS_25 } [get_ports { fmc_miso_n }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVDS_25 } [get_ports { fmc_mosi_p }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN A19   IOSTANDARD LVDS_25 } [get_ports { fmc_mosi_n }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVDS_25 } [get_ports { fmc_clk_p }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVDS_25 } [get_ports { fmc_clk_n }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVDS_25 } [get_ports { fmc_usr_p }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVDS_25 } [get_ports { fmc_usr_n }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]

set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS25 } [get_ports { sca_scl9 }]; #IO_L18N_T2_A23_15 Sch=fmc_la_n[04]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS25 } [get_ports { sca_sda9 }]; #IO_L20P_T3_A20_15 Sch=fmc_la_p[07]
